...
export function PayrollGate() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    setSubmitting(true);
    try {
      const res = await fetch("/api/admin/payroll-auth", {
        method: "POST",
  ...
  return (
    <div className="mx-auto max-w-xs px-6 py-20">
      <p className="text-sm tracking-[0.2em] text-coral uppercase mb-1">Payroll</p>
      <h1 className="font-display text-2xl mb-2">급여 계산</h1>
