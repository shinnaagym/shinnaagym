...
// unlocked는 항상 false로 시작한다. 즉, 다른 admin 페이지로 이동했다가 다시
// 급여 계산으로 들어오면 서버 세션이 아직 유효해도 비밀번호를 다시 확인한다.
// 서버의 payroll 세션 쿠키는 잠금 해제 화면에서 벗어날지 여부와 무관하게,
// 잠금 해제된 동안 데이터 API 호출(session-counts, payroll 저장/조회)이
// 통과하도록 뒷받침하는 용도로만 쓰인다.
